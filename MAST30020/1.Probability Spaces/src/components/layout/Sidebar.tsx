...
const MODULES: ModuleConfig[] = [
  { id: 'sample-spaces', title: 'Sample Spaces', subtitle: 'Random experiments & Ω', katexSymbol: '\\Omega' },
  { id: 'events-operations', title: 'Events & Set Ops', subtitle: 'Subsets, indicators, De Morgan', katexSymbol: 'A \\subset \\Omega' },
  { id: 'sigma-algebras', title: 'σ-Algebras', subtitle: 'Definition, Borel sets, σ(G)', katexSymbol: '\\mathcal{F}' },
  { id: 'probability-measure', title: 'Probability', subtitle: 'Axioms, properties, continuity', katexSymbol: 'P' },
  { id: 'borel-cantelli', title: 'Borel-Cantelli', subtitle: 'lim sup, first lemma', katexSymbol: 'A_n \\text{ i.o.}' },
];
...
export const Sidebar: React.FC<SidebarProps> = ({ activeModule, onModuleSelect }) => {
  return (
    <>
      {/* Desktop sidebar */}
      <nav className="hidden md:flex flex-col w-60 shrink-0 space-y-1.5">
        {MODULES.map((mod, idx) => {
